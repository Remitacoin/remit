...
/* remita GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Remita Coin"
#define QAPP_ORG_DOMAIN "remita.trade"
#define QAPP_APP_NAME_DEFAULT "Remita Coin-Qt"
#define QAPP_APP_NAME_TESTNET "Remita Coin-Qt-testnet"
