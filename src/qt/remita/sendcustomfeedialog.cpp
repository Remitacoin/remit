...
#include "qt/remita/sendcustomfeedialog.h"
#include "qt/remita/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(remitaGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &remitaGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
