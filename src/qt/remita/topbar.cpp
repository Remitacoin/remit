...
#include "qt/remita/topbar.h"
#include "qt/remita/forms/ui_topbar.h"
#include "qt/remita/lockunlock.h"
#include "qt/remita/qtutils.h"
#include "qt/remita/receivedialog.h"
#include "qt/remita/loadingdialog.h"
...
TopBar::TopBar(remitaGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopREMIT}, "amount-small-topbar");
    setCssProperty({ui->labelAmountREMIT}, "amount-topbar");
    setCssProperty({ui->labelPendingREMIT, ui->labelImmatureREMIT}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("remita")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // REMIT Total
    QString totalREMIT = GUIUtil::formatBalance(balance, nDisplayUnit);

    // REMIT
    // Top
    ui->labelAmountTopREMIT->setText(totalREMIT);
    // Expanded
    ui->labelAmountREMIT->setText(totalREMIT);
    ui->labelPendingREMIT->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureREMIT->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
