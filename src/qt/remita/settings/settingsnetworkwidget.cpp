...
#include "qt/remita/settings/settingsnetworkwidget.h"
#include "qt/remita/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/remita/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(remitaGUI* _window, QWidget *parent) :
