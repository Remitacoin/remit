...
#include "qt/remita/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/remita/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(remitaGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the Remita Coin RPC console.") + "<br>" +
