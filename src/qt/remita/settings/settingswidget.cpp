...
#include "qt/remita/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(remitaGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &remitaGUI::openFAQ);
