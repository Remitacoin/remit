...
#include "qt/remita/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/remita/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(remitaGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to remitaGUI::handleRestart()
