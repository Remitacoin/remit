...
#include "qt/remita/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(remitaGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("remita_tx_csv_export(*.csv)") : tr("remita_addresses_csv_export(*.csv)"),
                                        nullptr);
