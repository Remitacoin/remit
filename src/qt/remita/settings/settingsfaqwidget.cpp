...
#include "qt/remita/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/remita/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(remitaGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableREMIT,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableREMIT,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableREMIT,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableREMIT,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableREMIT, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableREMIT);});
    ...
    if (parent)
        connect(parent, &remitaGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
