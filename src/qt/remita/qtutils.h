...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, remitaGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, remitaGUI* gui, double posX = 3);
