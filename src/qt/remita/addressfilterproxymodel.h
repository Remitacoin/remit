...
#ifndef remita_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define remita_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //remita_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
