...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            remitaGUI* window = static_cast<remitaGUI*>(parentWidget());
...
{
    remitaGUI* gui = static_cast<remitaGUI*>(parentWidget());
...
{
    hide();
    static_cast<remitaGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Remita Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your REMITs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
