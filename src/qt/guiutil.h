...
/** Utility functions used by the remita Qt UI.
 */
namespace GUIUtil
{
...
// Render remita addresses in monospace font
...
// Parse "remita:" URI into recipient object, return true on successful parsing
