...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Remita Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Remita Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* remita features */
        {"remita", "listmasternodes", &listmasternodes, true, true, false},
        {"remita", "getmasternodecount", &getmasternodecount, true, true, false},
        {"remita", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"remita", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"remita", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"remita", "masternodecurrent", &masternodecurrent, true, true, false},
        {"remita", "masternodedebug", &masternodedebug, true, true, false},
        {"remita", "startmasternode", &startmasternode, true, true, false},
        {"remita", "createmasternodekey", &createmasternodekey, true, true, false},
        {"remita", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"remita", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"remita", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"remita", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"remita", "getmasternodescores", &getmasternodescores, true, true, false},
        {"remita", "preparebudget", &preparebudget, true, true, false},
        {"remita", "submitbudget", &submitbudget, true, true, false},
        {"remita", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"remita", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"remita", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"remita", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"remita", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"remita", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"remita", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"remita", "checkbudgets", &checkbudgets, true, true, false},
        {"remita", "mnsync", &mnsync, true, true, false},
        {"remita", "spork", &spork, true, true, false},
...
{
    return "> remita-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8352/\n";
}
