...
The build script we'll be using is contained in the remita github repository ([contrib/gitian-build.py](https://github.com/remitavps-project/remita/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the remita repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/remitavps-project/remita/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, remita-detached-sigs, and remita GitHub repos.
