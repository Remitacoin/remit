...
The script [extract-osx-sdk.sh](https://github.com/remitavps-project/remita/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
remita/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/remitavps-project/remita/blob/master/doc/README_osx.md) for troubleshooting tips.
