...
RESOURCES += src/qt/remita.qrc src/qt/remita_locale.qrc

TRANSLATIONS += src/qt/locale/remita_bg.ts \
                src/qt/locale/remita_de.ts \
                src/qt/locale/remita_en.ts \
                src/qt/locale/remita_es.ts \
                src/qt/locale/remita_fi.ts \
                src/qt/locale/remita_fr.ts \
                src/qt/locale/remita_it.ts \
                src/qt/locale/remita_ja.ts \
                src/qt/locale/remita_pl.ts \
                src/qt/locale/remita_pt.ts \
                src/qt/locale/remita_ru.ts \
                src/qt/locale/remita_sk.ts \
                src/qt/locale/remita_sv.ts \
                src/qt/locale/remita_vi.ts \
                src/qt/locale/remita_zh_CN.ts \
                src/qt/locale/remita_zh_TW.ts
