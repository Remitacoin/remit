Contributing to remita
============================

The remita project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/remitavps-project/remita/blob/master/doc/translation_process.md)
...
The following applies to code changes to the remita project, and is not to be
confused with overall remita Network Protocol consensus changes.

Whether a pull request is merged into remita rests with the project merge
...
Patches that change remita consensus rules are considerably more involved than
...
Where a patchset proposes to change the remita consensus, it must have been
...
The project leader is the release manager for each remita release.
